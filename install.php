  ...
  <body>
    ...
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand" href="#">DOJ Setup</a>
        </div>
      </div>
    </div>
    ...
    <?php
      if(isset($_GET['installed'])) {?>
        <div class="alert alert-success">DOJ is successfully installed!</div>
    ...
    Welcome to the DOJ setup. This will help you set up DOJ on your server. Make sure that you have MySQL running before you proceed.
    ...
    <?php } else {?>
      <div class="alert alert-error">DOJ is already installed. Please remove the files and re-install it.</div>
    <?php } ?>
    </div> <!-- /container -->
